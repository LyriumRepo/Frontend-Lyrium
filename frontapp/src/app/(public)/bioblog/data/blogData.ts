...
export const heroPosts: HeroPost[] = [
    ...
    },
    {
        ...
        alt: 'Meditar en familia: rituales sencillos para conectar en casa',
        category: 'SALUD ESPIRITUAL',
        title: 'Meditar en familia: rituales sencillos para conectar en casa',
        url: 'https://lyriumbiomarketplace.com/entrada-6/',
        date: 'JUNIO 2, 2025',
        excerpt: 'Pequeños rituales diarios que ayudan a toda la familia a bajar el ritmo y reconectar entre sí...',
    },
    {
        id: '6',
        img: '/img/bioblog/Familia-en-picnic-scaled.webp',
        alt: 'Actividades al aire libre para fortalecer los lazos familiares',
        category: 'SALUD FAMILIAR',
        title: 'Actividades al aire libre para fortalecer los lazos familiares',
        url: 'https://lyriumbiomarketplace.com/entrada-7/',
        date: 'JUNIO 10, 2025',
        excerpt: 'Salir a la naturaleza en familia mejora el vínculo emocional y reduce el estrés de toda la casa...',
    },
];
...
export const blogPosts: BlogPost[] = [
    ...
    {
        id: '5',
        img: '/img/bioblog/cuidado_personal.jpg',
        category: 'SALUD ALIMENTARIA',
        title: '5 hábitos alimenticios que transforman tu energía diaria',
        url: 'https://lyriumbiomarketplace.com/entrada-8/',
        date: 'MAYO 28, 2025',
        excerpt: 'Pequeños cambios en tu rutina de alimentación pueden marcar una gran diferencia en tu nivel de energía y concentración.',
    },
    {
        id: '6',
        img: '/img/bioblog/entrevista_doctora-scaled.webp',
        category: 'SALUD ALIMENTARIA',
        title: 'Lo que dice la ciencia sobre los superalimentos',
        url: 'https://lyriumbiomarketplace.com/entrada-9/',
        date: 'MAYO 15, 2025',
        excerpt: 'Revisamos la evidencia detrás de la quinua, la maca y otros superalimentos peruanos que ganan popularidad mundial.',
    },
    {
        id: '7',
        img: '/img/bioblog/Fondos_BioBlog-6.webp',
        category: 'SALUD ALIMENTARIA',
        title: 'Cómo leer las etiquetas nutricionales sin perderte',
        url: 'https://lyriumbiomarketplace.com/entrada-10/',
        date: 'ABRIL 30, 2025',
        excerpt: 'Aprende a identificar azúcares ocultos, grasas trans y otros ingredientes clave antes de llevar un producto a tu mesa.',
    },
    {
        id: '8',
        img: '/img/bioblog/laptop.jpg',
        category: 'SALUD AMBIENTAL',
        title: 'Empaques biodegradables: la nueva tendencia en marketplaces',
        url: 'https://lyriumbiomarketplace.com/entrada-11/',
        date: 'MAYO 22, 2025',
        excerpt: 'Cada vez más vendedores apuestan por empaques compostables. Te contamos por qué importa y cómo adoptarlo en tu tienda.',
    },
    {
        id: '9',
        img: '/img/bioblog/joven-sentado.jpg',
        category: 'SALUD AMBIENTAL',
        title: 'Reduce tu huella de carbono con pequeños cambios diarios',
        url: 'https://lyriumbiomarketplace.com/entrada-12/',
        date: 'ABRIL 18, 2025',
        excerpt: 'No hace falta una revolución: pequeños hábitos sostenibles en casa y en el trabajo suman un gran impacto ambiental.',
    },
    {
        id: '10',
        img: '/img/bioblog/chica-sentada.jpg',
        ...
        url: 'https://lyriumbiomarketplace.com/entrada-13/',
        date: 'MAYO 10, 2025',
        excerpt: 'Técnicas simples de respiración y organización mental para sobrellevar los días de mayor carga emocional.',
    },
    {
        id: '11',
        img: '/img/bioblog/Familia-en-picnic-scaled.webp',
        category: 'SALUD EMOCIONAL',
        title: 'El poder de la gratitud en tu bienestar diario',
        url: 'https://lyriumbiomarketplace.com/entrada-14/',
        date: 'ABRIL 12, 2025',
        excerpt: 'Practicar la gratitud de forma consciente mejora el estado de ánimo y fortalece las relaciones cercanas.',
    },
    {
        id: '12',
        img: '/img/bioblog/entrevista_doctora-scaled.webp',
        category: 'SALUD ESPIRITUAL',
        title: 'Prácticas de mindfulness para principiantes',
        url: 'https://lyriumbiomarketplace.com/entrada-15/',
        date: 'MAYO 6, 2025',
        excerpt: 'Una guía sencilla para empezar a meditar sin experiencia previa, con ejercicios de 5 minutos al día.',
    },
    {
        id: '13',
        img: '/img/bioblog/cuidado_personal.jpg',
        category: 'SALUD ESPIRITUAL',
        title: 'Conecta con tu propósito: ejercicios de introspección',
        url: 'https://lyriumbiomarketplace.com/entrada-16/',
        date: 'ABRIL 8, 2025',
        excerpt: 'Preguntas y ejercicios prácticos para identificar qué te motiva de verdad y alinear tus decisiones diarias.',
    },
    {
        id: '14',
        img: '/img/bioblog/blog-teclas.jpg',
        category: 'SALUD FAMILIAR',
        title: 'Recetas saludables para cocinar en familia',
        url: 'https://lyriumbiomarketplace.com/entrada-17/',
        date: 'MAYO 2, 2025',
        excerpt: 'Recetas fáciles y nutritivas para preparar en casa con los más pequeños, fomentando hábitos saludables desde niños.',
    },
];
