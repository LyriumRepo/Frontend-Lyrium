        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white dark:bg-[var(--bg-card)] border border-gray-100 dark:border-[var(--border-subtle)] rounded-[2.5rem] shadow-xl overflow-hidden p-8 text-center relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div className="p-5 bg-white dark:bg-[var(--bg-card)] rounded-2xl border border-gray-100 dark:border-[var(--border-subtle)] space-y-3">
                ...
                <p className="text-sm font-bold text-gray-800 dark:text-[var(--text-primary)]">
                  {addressLines || 'Sin dirección especificada'}
                </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Link
                href="/"
                className="px-8 py-4 rounded-2xl border-2 border-gray-100 dark:border-[var(--border-subtle)] text-gray-500 dark:text-[var(--text-muted)] hover:bg-gray-50 dark:hover:bg-[var(--bg-muted)] font-black text-xs uppercase tracking-widest transition-all text-center flex items-center justify-center gap-2"
              >
                <Home className="w-4 h-4" /> Ir al Inicio
              </Link>
              <Link
                href="/customer/orders"
                className="px-8 py-4 rounded-2xl bg-gray-900 dark:bg-[var(--bg-secondary)] text-white dark:text-[var(--text-primary)] font-black text-xs uppercase tracking-widest hover:shadow-xl transition-all text-center flex items-center justify-center gap-2"
              >
                Ver Mis Pedidos
              </Link>
              <button
