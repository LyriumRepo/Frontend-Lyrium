                        ...
                        {phase === 1 ? (
                            <div className="space-y-4">
                                <div className="text-center space-y-3">
                                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-sky-50 dark:bg-emerald-900/30 rounded-full">
                                        <div className="w-1.5 h-1.5 rounded-full bg-sky-500 dark:bg-emerald-500 animate-pulse" />
                                        <span className="text-[10px] font-black text-sky-600 dark:text-emerald-400 uppercase tracking-widest">Bóveda de Seguridad Lyrium</span>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="p-3 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-emerald-900/20 rounded-2xl border border-purple-100 dark:border-purple-800/30 flex items-center gap-3">
                                ...
                                <div className="flex flex-col gap-2">
                                    <button
                                        onClick={handleSync}
                                        className="w-full py-3 rounded-2xl bg-gray-900 dark:bg-[var(--bg-secondary)] text-white font-black text-xs uppercase tracking-[0.2em] hover:bg-sky-600 dark:hover:bg-emerald-600 transition-all shadow-xl shadow-gray-200 dark:shadow-gray-900/20 hover:shadow-sky-200 dark:hover:shadow-emerald-900/20 hover:-translate-y-0.5"
                                    >
                            ...
                            <div className="space-y-4 animate-fade-in">
                                <div className="flex flex-col items-center gap-3">
                                    <div className="relative w-20 h-20">
                                        <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 100 100">
                                            ...
                                            <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" strokeWidth="8" strokeDasharray="282.7" strokeDashoffset="56.5" className="text-sky-500 dark:text-emerald-500 transition-all duration-1000 ease-out" />
                                        </svg>
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <span className="text-4xl">⚡</span>
                                        </div>
                                        <div className="absolute -top-1 -right-1 bg-sky-500 dark:bg-emerald-600 text-white text-[10px] font-black px-2 py-0.5 rounded-full shadow-lg">80%</div>
                                    </div>
                                    <div className="text-center space-y-1">
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-[var(--text-muted)] font-medium leading-relaxed">
                                            ...
                                            <span className="text-sky-600 dark:text-emerald-400 font-bold">Activa tu panel</span> para finalizar.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    <button
                                        ...
                                        className="w-full py-3 rounded-2xl bg-sky-500 dark:bg-emerald-600 text-white font-black text-xs uppercase tracking-[0.2em] hover:bg-sky-600 dark:hover:bg-emerald-700 transition-all shadow-xl shadow-sky-200 dark:shadow-emerald-900/20 hover:-translate-y-0.5 flex items-center justify-center gap-2"
                                    >
