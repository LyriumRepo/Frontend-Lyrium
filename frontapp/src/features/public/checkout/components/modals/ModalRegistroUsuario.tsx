                    ...
                    <div className="bg-white dark:bg-[var(--bg-card)] p-5 space-y-4 overflow-y-auto [scrollbar-width:thin] [scrollbar-color:#bae6fd_transparent] dark:[scrollbar-color:#2A5A4D_transparent]">
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {[
                                    { icon: '🚚', label: 'Tracking', bg: 'bg-sky-50 dark:bg-emerald-900/20 border-sky-100 dark:border-emerald-800/30 text-sky-500 dark:text-emerald-400' },
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            <div className="space-y-1.5">
                                ...
                                <div className="px-4 py-2.5 bg-gray-50 dark:bg-[var(--bg-muted)] border border-gray-100 dark:border-[var(--border-subtle)] rounded-xl text-gray-500 dark:text-[var(--text-muted)] font-bold text-sm flex items-center gap-3">
                                    <span className="text-sky-400 dark:text-emerald-400 text-lg">@</span>
                            ...
                            <div className="space-y-1.5 group">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-sky-500 dark:group-focus-within:text-emerald-400 transition-colors">
                                        🔒
                                    </div>
                                    <input
                                        ...
                                        className="w-full pl-10 pr-10 py-3.5 bg-white dark:bg-[var(--bg-card)] border border-gray-200 dark:border-[var(--border-subtle)] rounded-xl text-gray-900 dark:text-[var(--text-primary)] font-bold text-sm focus:ring-2 focus:ring-sky-500/20 dark:focus:ring-emerald-500/20 focus:border-sky-500 dark:focus:border-emerald-500 transition-all"
                                        placeholder="Mínimo 8 caracteres"
                                    />
                                    <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-sky-500 dark:hover:text-emerald-400 transition-colors">
                            ...
                            <div className="pt-1.5 space-y-2.5">
                                <button
                                    ...
                                    className={`w-full py-3.5 rounded-xl font-black text-[11px] uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2 ${status === 'success'
                                        ...
                                        : 'bg-gray-900 dark:bg-[var(--bg-secondary)] text-white hover:bg-sky-500 dark:hover:bg-emerald-600 hover:-translate-y-0.5 active:translate-y-0'
                                        } disabled:opacity-70`}
                                >
                                ...
                                <div className="flex flex-col items-center gap-1.5 pt-1">
                                    <a href="/login" className="text-[8px] font-bold text-sky-500 dark:text-emerald-400 uppercase tracking-widest hover:text-sky-600 dark:hover:text-emerald-300 transition-colors flex items-center gap-1">
