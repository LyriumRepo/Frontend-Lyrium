...
export const termsData: { [key: string]: TermSection[] } = {
    cliente: [
        ...
        <p class="mb-4">Los datos personales requeridos por el Marketplace, tales como nombres, apellidos, RUC (opcional), tipo de documento de identidad, número de documento de identidad, domicilio, departamento, provincia, número de contacto y correo electrónico serán de uso exclusivo del sitio para concretas las operaciones de compra y venta que el usuario desee realizar.</p>
