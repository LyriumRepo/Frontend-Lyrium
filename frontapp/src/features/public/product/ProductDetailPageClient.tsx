...
function StickerBadge({ sticker }: { sticker: string | null }) {
    ...
    const config = stickerMap[sticker] ?? { label: sticker, className: 'bg-gray-500 text-white' };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className={`flex items-center gap-2 text-sm font-semibold ${
                            inStock ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500'
                        }`}>
                                    ...
                                    {product.weight && (
                                        <div className="flex items-center gap-3 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-semibold text-gray-700 dark:text-[var(--text-primary)]">{product.weight} kg</p>
                                            </div>
                                        </div>
                                    )}
                                    {product.dimensions && (
                                        <div className="flex items-center gap-3 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-semibold text-gray-700 dark:text-[var(--text-primary)]">{product.dimensions}</p>
                                            </div>
                                        </div>
                                    )}
                                    {product.expirationDate && (
                                        <div className="flex items-center gap-3 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-semibold text-gray-700 dark:text-[var(--text-primary)]">{product.expirationDate}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            {relatedProducts.slice(0, 8).map((rel) => (
                                ...
                                >
                                    <div className="relative aspect-square overflow-hidden bg-gray-50 dark:bg-[var(--bg-primary)]">
                                        <Image
                                            src={rel.images[0]?.medium ?? rel.images[0]?.src ?? '/no-image.png'}
