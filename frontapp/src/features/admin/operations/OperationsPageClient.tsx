...
} from '@/components/admin/operations/OperationsModals';
...
export function OperationsPageClient(_props: OperationsPageClientProps) {
  ...
  const handleSaveProvider = (providerData: Partial<Supplier>) => {
    actions.request2FA(() => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn font-industrial">
      ...
      <BaseModal
        ...
        title={selectedProvider?.id ? 'Editar Proveedor' : 'Nuevo Proveedor'}
