...
const MOCK_FINANCE_DATA: FinanceData = {
  ...
  heatmap: [
    ...
    { day: 'Lun', hour: 14, value: 65 },
    { day: 'Mar', hour: 11, value: 90 },
    { day: 'Mar', hour: 15, value: 95 },
    { day: 'Mie', hour: 9, value: 70 },
    { day: 'Mie', hour: 16, value: 85 },
    { day: 'Jue', hour: 10, value: 75 },
    { day: 'Jue', hour: 17, value: 88 },
    { day: 'Vie', hour: 11, value: 92 },
    { day: 'Vie', hour: 18, value: 78 },
    { day: 'Sáb', hour: 12, value: 100 },
    { day: 'Sáb', hour: 14, value: 85 },
    { day: 'Dom', hour: 13, value: 60 },
    { day: 'Dom', hour: 16, value: 45 },
  ],
};
