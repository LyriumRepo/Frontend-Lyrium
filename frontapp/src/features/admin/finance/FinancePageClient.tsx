              ...
              <div className="lg:col-span-2 space-y-8">
                <button
                  onClick={() => openKpi(
                    ...
                    formatCurrency(data.ingresosBrutos.data.reduce((a: number, b: number) => a + b, 0)),
                    ...
                    <div className="flex flex-wrap gap-6">
                      ...
                      <div>
                        ...
                        <span className="text-2xl font-black text-emerald-500">
                          {formatCurrency(data.ingresosNetos.data.reduce((a: number, b: number) => a + b, 0))}
                        </span>
                      </div>
                      <div className="w-[1px] h-10 bg-[var(--border-subtle)] hidden sm:block" />
                      <div>
                        ...
                        <span className="text-2xl font-black text-amber-500">
                          {formatCurrency(data.ingresosReales.data.reduce((a: number, b: number) => a + b, 0))}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <BaseStatCard
                    ...
                    value={data.ventasTotales.data.reduce((a: number, b: number) => a + b, 0).toString()}
                    ...
                    onClick={() => openKpi(
                      'Ventas Totales',
                      data.ventasTotales.data.reduce((a: number, b: number) => a + b, 0).toString(),
                  ...
                  <BaseStatCard
                    ...
                    value={formatCurrency(
                      data.ingresosBrutos.data.reduce((a: number, b: number) => a + b, 0) /
                        Math.max(data.ventasTotales.data.reduce((a: number, b: number) => a + b, 0), 1),
                    )}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <BaseStatCard
                ...
                value={formatCurrency(data.ingresosReales.data.reduce((a: number, b: number) => a + b, 0))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-[var(--border-subtle)]">
              ...
              <div className="space-y-4">
                {data.topBuyers.map((buyer: TopBuyer, i: number) => (
                  <div
                    key={buyer.id}
