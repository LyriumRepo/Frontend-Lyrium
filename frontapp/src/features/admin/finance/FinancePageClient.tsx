            ...
            <div className="space-y-12">
                ...
                {isVisible('monetario') && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            {/* Panel Principal - Izquierda (Col-span 2) */}
                            <div className="lg:col-span-2 space-y-8">
                                
                                {/* Tarjeta Hero: Centro de Control de Ingresos (Brutos vs Netos Consolidados) */}
                                ...
                                {/* Fila Secundaria: ROI y Ventas Totales */}
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    
                                    {/* ROI de Ventas - Gráfico de Radar */}
                                    <BaseStatCard
                                        label="ROI de Ventas"
                ...
                {isVisible('logistica') && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {/* Lead Time Despacho - Gráfico de Barras / Histogram */}
                            <BaseStatCard
                ...
                {isVisible('servicio') && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Tiempo de Respuesta - Histograma */}
                            <BaseStatCard
                ...
                {isVisible('satisfaccion') && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Tiempo de Respuesta - Gráfico de Áreas */}
                            <BaseStatCard
                                label="Tiempo de Respuesta"
                                value={`${data.tiempoRespuesta.data[data.tiempoRespuesta.data.length - 1]} min`}
