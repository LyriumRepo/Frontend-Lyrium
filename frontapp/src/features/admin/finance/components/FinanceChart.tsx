...
// Plugin anotaciones: marca el punto máximo y mínimo sobre la gráfica
const annotationsPlugin = {
    ...
    afterDatasetsDraw(chart: any) {
        ...
        // Usamos el primer dataset para calcular max/min
...
// Plugin crosshair: línea vertical que sigue el cursor en line/bar
    ...
    return (
        <div style={{ height }} className="relative">
            ...
            <div className="absolute top-2 right-2 z-10 flex items-center gap-1.5">
                {/* Exportar PNG — div para evitar <button> anidado dentro de BaseStatCard */}
                <div
                    role="button"
                    tabIndex={0}
