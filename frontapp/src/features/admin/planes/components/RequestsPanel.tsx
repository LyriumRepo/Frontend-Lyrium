              ...
              return (
                <div key={r.id ?? i} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 mx-4 my-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mb-4">
                    ...
                    <div className="bg-gray-50 rounded-xl p-2.5 border border-gray-100"><div className="text-[11px] text-gray-400 uppercase tracking-wide mb-0.5">MONTO</div><div className="text-[14px] font-bold text-gray-700">S/ {Number(r.amount ?? 0).toFixed(2)}</div></div>
