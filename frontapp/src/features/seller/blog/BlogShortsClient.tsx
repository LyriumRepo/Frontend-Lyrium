...
import { Clapperboard, Plus, Globe, Clock, User, Save, Info, FileText, BookOpen, Headphones, Video, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-fadeIn font-industrial pb-20">
            ...
            <BaseModal
                ...
                title={editingId ? 'Editar Short' : 'Nuevo Short'}
                footer={
