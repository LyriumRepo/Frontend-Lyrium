...
import { Clapperboard, Plus, Edit, Trash2, Globe, Clock, User, Send, CheckCircle, Save, Info, FileText, BookOpen, Headphones, Video } from 'lucide-react';
                            ...
                            {items.map(s => (
                                <tr key={s.id} className="border-b border-gray-50 dark:border-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition">
                                    ...
                                    <td className="px-5 py-4"><div className="flex gap-1.5 items-center">
                                        {s.status === 'draft' && (
                                            <button onClick={() => updateStatus(s.id, 'pending_review')} className="px-2.5 py-1.5 text-[11px] font-bold uppercase rounded-lg bg-teal-500 hover:bg-teal-600 text-white transition">
