        ...
        <div className="glass-card p-0 overflow-hidden border-none rounded-[2.5rem] shadow-2xl bg-[var(--bg-card)] mb-8">
            <div className="bg-gradient-to-r from-sky-500 to-sky-300 dark:from-[var(--brand-green)] dark:to-[#1A3A32] p-8 flex items-center justify-between relative overflow-hidden">
                ...
                <button
                    ...
                    disabled={atLimit}
                    className={`relative z-10 flex items-center gap-2 px-6 py-3 rounded-xl backdrop-blur-md font-black text-xs border uppercase tracking-widest transition-all shadow-lg shadow-black/5 ${
                        atLimit
                ...
                >
                    <Plus className="w-4 h-4" /> {atLimit ? 'Límite Alcanzado' : 'Agregar Sucursal'}
                </button>
            </div>
