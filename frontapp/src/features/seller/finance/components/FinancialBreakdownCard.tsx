...
export default function FinancialBreakdownCard({ data }: FinancialBreakdownCardProps) {
    ...
    return (
        <div className="bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-[var(--border-subtle)] shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-[var(--border-subtle)]/30 hover:-translate-y-1">
