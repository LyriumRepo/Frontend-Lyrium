...
export const defaultPlansData: PlansMap = {
  basic: {
    ...
    bgImage: '/planes/plan-emprende.png', showBgInCard: true, customCSS: '', requiresPayment: false,
  ...
  standard: {
    ...
    bgImage: '/planes/plan-crece.png', showBgInCard: true, customCSS: '', requiresPayment: true,
    subscribeButtonText: 'Suscribirse',
  ...
  premium: {
    ...
    bgImage: '/planes/plan-especial.png', showBgInCard: true, customCSS: '', requiresPayment: false,
