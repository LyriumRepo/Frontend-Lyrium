...
export const defaultPlansData: PlansMap = {
  basic: {
    ...
    bgImage: '/planes/plan-emprende.png', customCSS: '', requiresPayment: false,
  ...
  standard: {
    ...
    bgImage: '/planes/plan-crece.png', customCSS: '', requiresPayment: true,
    subscribeButtonText: 'Suscribirse',
  ...
  premium: {
    ...
    bgImage: '/planes/plan-especial.png', customCSS: '', requiresPayment: false,
