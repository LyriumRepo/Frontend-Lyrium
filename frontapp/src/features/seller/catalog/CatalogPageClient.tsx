...
function PriceEditInput({ product, onPriceUpdate }: PriceEditInputProps) {
        ...
        return (
            <div className="flex items-center gap-1.5">
                    <input
                        ...
                        className="w-20 px-2 py-1 text-xs text-center border border-sky-500/30 rounded-lg focus:ring-2 focus:ring-sky-500/20 bg-[var(--bg-card)] text-[var(--text-primary)] font-semibold"
                    step="0.01"
                    disabled={isUpdating}
                    autoFocus
                />
    ...
    return (
        <button
            ...
            className="flex items-center justify-center gap-1 group/price w-full"
            title="Editar precio"
        >
        ...
        <div className={`rounded-2xl border bg-[var(--bg-card)] overflow-hidden transition-colors ${
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] font-semibold text-sky-500 dark:text-[#8FC3A1] mt-0.5">
                        S/ {product.price.toFixed(2)}
                    </p>
                </div>
            ...
            {expanded && (
                <div className="border-t border-[var(--border-subtle)] px-4 py-3 space-y-2.5">
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-[9px] font-semibold uppercase tracking-widest text-[var(--text-secondary)]">Categoría</span>
                    ...
                    {/* Detalle: Precio */}
                    <div className="flex items-center justify-between">
                        <span className="text-[9px] font-semibold uppercase tracking-widest text-[var(--text-secondary)]">Precio</span>
                        <span className="text-sm font-semibold text-[var(--text-primary)]">S/ {product.price.toFixed(2)}</span>
                    </div>

                    {/* Detalle: Stock */}
                    <div className="flex items-center justify-between">
                        <span className="text-[9px] font-semibold uppercase tracking-widest text-[var(--text-secondary)]">Stock</span>
                    ...
                    <div className="flex items-center gap-2 pt-1">
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl border border-[var(--border-subtle)] text-[11px] font-semibold text-[var(--text-secondary)] hover:border-sky-500/30 hover:text-sky-500 hover:bg-sky-500/5 dark:hover:border-[#8FC3A1]/30 dark:hover:text-[#8FC3A1] transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl border border-red-500/20 text-[11px] font-semibold text-red-400 hover:bg-red-500/10 transition-colors"
                        >
...
export default function CatalogClient({ initialProducts }: CatalogClientProps) {
    ...
    return (
        ...
        <div className="space-y-8 animate-fadeIn pb-20">
            ...
            {/* Success Modal */}
            {showSuccessModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" role="dialog" aria-modal="true" tabIndex={-1} onClick={() => setShowSuccessModal(false)} onKeyDown={(e) => { if (e.key === 'Escape') setShowSuccessModal(false); }}>
