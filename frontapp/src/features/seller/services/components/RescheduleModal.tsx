      ...
      <div className="p-8 space-y-8">
        <div className="bg-[var(--bg-secondary)]/50 p-8 rounded-[2.5rem] border border-[var(--border-subtle)] shadow-inner space-y-6">
          <div className="flex flex-col items-center text-center gap-2 mb-4">
            ...
            <p className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest leading-none">
              Cliente
            </p>
          ...
          <div className="space-y-3">
            <label
              ...
              className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest ml-1 block text-center"
            >
              Nueva Marca Horaria
            </label>
            <div className="relative group">
              <Icon
                name="Clock"
                className="absolute left-6 top-1/2 -translate-y-1/2 text-[var(--brand-sky)] w-5 h-5 z-10 transition-transform group-hover:scale-110"
              />
              <input
                id="reschedule-time"
                type="time"
            ...
            <div className="p-5 bg-[var(--bg-danger)] border border-[var(--text-danger)]/20 rounded-[2rem] animate-shake">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-[10px] font-black text-[var(--text-danger)] uppercase tracking-widest">
                    Conflicto de Agenda
                  </p>
                  <p className="text-[9px] font-bold text-[var(--text-danger)]/70 leading-tight mt-0.5">
                    La franja horaria seleccionada ya cuenta con una operación
                    activa.
                  </p>
                </div>
              </div>
