...
function isServiceActive(service: Service): boolean {
  return (
    service.diasAtencion.length > 0 && service.especialistasAsignados.length > 0
  );
}
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div
              className={`flex items-center gap-5 p-6 rounded-[2.5rem] border shadow-sm transition-all
                            ${
                              active
...
<<<<<<< HEAD
            ...
            >
              <div className="relative flex-shrink-0">
                <div
                  className={`w-4 h-4 rounded-full ${active ? 'bg-emerald-500' : 'bg-rose-500'}`}
                />
                {active && (
              ...
              <div>
                <p
                  className={`text-sm font-black tracking-tight ${active ? 'text-emerald-500' : 'text-rose-500'}`}
                >
...
>>>>>>> origin/rama-jere2
          ...
          <div className="space-y-4">
            ...
            <div className="flex -space-x-3 p-4 bg-[var(--bg-secondary)]/30 rounded-[2.5rem] border border-[var(--border-subtle)] min-h-[5.5rem] items-center px-8 shadow-inner">
              {assignedSpecialists.length === 0 ? (
                <p className="text-[10px] font-bold text-[var(--text-secondary)] italic">
                  Sin asignar
                </p>
              ) : (
                assignedSpecialists.map((esp) => (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="p-3 bg-white/5 rounded-2xl border border-white/10">
                  <Icon
                    name="TrendingUp"
                    className="text-emerald-300 w-5 h-5"
                  />
                </div>
                <div>
                  <p className="text-xl font-black tracking-tight">
