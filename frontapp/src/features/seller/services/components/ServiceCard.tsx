...
<<<<<<< HEAD
  ...
  return (
    <div
      className={`glass-card bg-[var(--bg-card)] p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all group animate-fadeIn flex flex-col justify-between h-full border-l-4
        ...
        <div className="flex justify-between items-start mb-3">
          <div className="flex-1 min-w-0 pr-2">
            ...
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              <span
                className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md border text-[8px] font-black uppercase tracking-wider
                                ${
                                  isPublished
          ...
          >
            {isPublished ? (
              ...
              <>
                ...
                {publishable
                  ? 'Publicar servicio'
                  : 'Publicar (asigna un especialista)'}
              </>
            )}
          </button>
