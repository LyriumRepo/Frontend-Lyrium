...
const MOCK_CLIENTS: Client[] = [
    ...
    },
    {
        ...
        direccion: 'Urb. Santa Rosa 210',
    },
    // ── Nuevos clientes ───────────────────────────────────────────────────────
    {
        // Compra sesión con especialista 4 en Servicio 1 (Miércoles mañana)
        id: 6,
        nombres: 'Diego',
        apellidos: 'Flores',
        dni: '56781234',
        ...
        direccion: 'Calle Las Flores 33',
    },
    {
        // Compra sesión con especialista 5 en Servicio 2 (Martes tarde · bloque 1)
        id: 7,
        nombres: 'Valentina',
        apellidos: 'Ríos',
        dni: '34127890',
    ...
    {
        // Compra sesión con especialista 6 en Servicio 2 (Viernes · día distinto)
        id: 8,
        nombres: 'Andrés',
        apellidos: 'Cárdenas',
        dni: '67890123',
        ...
        direccion: 'Jr. Moquegua 234',
    },
    {
        // Compra sesión con especialista 5 en Servicio 2 (Jueves mañana)
        id: 9,
        nombres: 'Isabella',
        apellidos: 'Navarro',
        dni: '90123456',
...
const MOCK_SPECIALISTS: Specialist[] = [
    {
        ...
        subEspecialidad: 'Rendimiento físico',
        aniosExperiencia: 8,
        categoria: 'Salud y Bienestar',
        numeroColegiatura: 'CNP-8801',
    ...
    },
    {
        ...
        subEspecialidad: 'Técnicas orientales',
        aniosExperiencia: 3,
    ...
    {
        // Servicio 1 · mismo día y bloques que María → escenario: 2 especialistas, mismo día, mismos bloques
        id: 4,
        nombres: 'Roberto',
        apellidos: 'Sánchez',
        dni: '55667788',
        ...
        subEspecialidad: 'Nutrición pediátrica',
        aniosExperiencia: 4,
        categoria: 'Salud y Bienestar',
        numeroColegiatura: 'CNP-4422',
        availability: 'Ocupado',
    },
    {
        // Servicio 2 · Martes tarde (bloque 1) + Jueves mañana → escenario: mismo día, bloques distintos
        id: 5,
        nombres: 'Patricia',
        apellidos: 'Mendoza',
        dni: '33445566',
        ...
        especialidad: 'Fisioterapia',
        subEspecialidad: 'Rehabilitación postoperatoria',
        aniosExperiencia: 6,
        categoria: 'Salud y Bienestar',
        availability: 'Ocupado',
    },
    {
        // Servicio 2 · Viernes → escenario: distintos especialistas en distintos días
        id: 6,
        nombres: 'Fernando',
        apellidos: 'Quispe',
        dni: '22334455',
        ...
        especialidad: 'Fisioterapia',
        subEspecialidad: 'Terapia manual ortopédica',
        aniosExperiencia: 9,
        categoria: 'Salud y Bienestar',
        numeroColegiatura: 'CNP-7700',
        availability: 'Ocupado',
    },
];
...
const MOCK_SERVICES: Service[] = [
    {
        ...
        // Especialistas 1 y 4 comparten los mismos días y bloques
        // → escenario: 2 especialistas · mismo día · mismos bloques
    ...
    },
    {
        ...
        // Especialista 2  → Martes bloque 0 (09:00-13:00) + Jueves bloque 0
        // Especialista 5  → Martes bloque 1 (14:00-18:00) + Jueves bloque 0
        //                    escenario: 2 especialistas · mismo día · bloques distintos
        // Especialista 6  → Viernes bloque 0
        //                    escenario: especialistas en días distintos
        especialistasAsignados: [2, 5, 6],
        diasAtencion: [
            {
                dia: 'Martes',
                bloques: [
                    { inicio: '09:00', fin: '13:00' }, // bloque 0 → especialista 2
                    { inicio: '14:00', fin: '18:00' }, // bloque 1 → especialista 5
                ],
            },
            {
                dia: 'Jueves',
                bloques: [
                    { inicio: '09:00', fin: '13:00' }, // bloque 0 → especialistas 2 y 5
                ],
            },
            {
                dia: 'Viernes',
                bloques: [
                    { inicio: '09:00', fin: '17:00' }, // bloque 0 → especialista 6
                ],
            },
        ],
    },
...
const MOCK_APPOINTMENTS: AppointmentWithClient[] = [
    ...
    },
    {
        ...
        sesion: { inicio: '11:40', fin: '12:25' },
        cuposOcupados: 2,
    },
    // ── Nuevas citas ──────────────────────────────────────────────────────────
    {
        // Servicio 1 · Especialista 4 · Miércoles
        // Escenario: 2 especialistas trabajando los mismos días y bloques
        // (misma franja horaria que María García pero sesión diferente)
        id: 106,
        serviceId: 1,
        specialistId: 4,
        clientId: 6,
        fecha: 'Miércoles 20 de Mayo',
        sesion: { inicio: '09:50', fin: '10:35' },
        cuposOcupados: 1,
    },
    {
        // Servicio 2 · Especialista 5 · Martes tarde (bloque 1: 14:00-18:00)
        // Escenario: mismo día que especialista 2 pero en un bloque diferente
        id: 107,
        serviceId: 2,
        specialistId: 5,
        clientId: 7,
        fecha: 'Martes 19 de Mayo',
        sesion: { inicio: '14:00', fin: '15:00' },
        cuposOcupados: 1,
    },
    {
        // Servicio 2 · Especialista 6 · Viernes (día exclusivo)
        // Escenario: especialista atendiendo en un día completamente distinto
        id: 108,
        serviceId: 2,
        specialistId: 6,
        clientId: 8,
    ...
    {
        // Servicio 2 · Especialista 5 · Jueves mañana (bloque 0)
        // Escenario: mismo especialista atendiendo en un día diferente al Martes
        id: 109,
        serviceId: 2,
        specialistId: 5,
        clientId: 9,
...
export function useSellerServices() {
    ...
    const { data: clients = [], isLoading: loadingClients } = useQuery({
        ...
        queryFn: async (): Promise<Client[]> => {
            ...
            try {
                ...
                console.warn('FALLBACK: Clients error', e);
                return [];
            }
        },
        staleTime: 5 * 60 * 1000,
    ...
    const { data: appointments = [], isLoading: loadingAppointments } = useQuery({
        ...
        queryFn: async (): Promise<AppointmentWithClient[]> => {
            ...
            try {
                return await bookingApi.sellerBookings() as unknown as AppointmentWithClient[];
            } catch (e) {
                ...
                old
                    ? old.map((app) =>
                        app.id === data.appointmentId
                            ? { ...app, fecha: data.newFecha, sesion: data.newSession }
                            : app,
                    )
                    : [],
            );
    ...
    return {
        ...
        handleReschedule: (appointmentId: number, newFecha: string, newSession: { inicio: string; fin: string }) =>
            rescheduleMutation.mutateAsync({ appointmentId, newFecha, newSession }),
