...
export default function IpsPageClient() {
  return (
    <div className="space-y-6 animate-fadeIn pb-20 max-w-7xl mx-auto">
      <ModuleHeader title="Gestión de IPs" subtitle="Control y monitoreo de direcciones IP" icon="Globe" />
      <div className="flex flex-col items-center justify-center min-h-[400px] bg-[var(--bg-card)] rounded-2xl border border-[var(--border-subtle)] p-12">
        <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900/30 rounded-2xl flex items-center justify-center mb-4">
          <Icon name="Globe" className="w-8 h-8 text-indigo-500" />
        </div>
        <h3 className="text-lg font-black text-[var(--text-primary)] mb-2">Gestión de IPs</h3>
        <p className="text-sm text-[var(--text-secondary)] text-center max-w-md">
          Módulo en preparación. Aquí se administrarán los bloqueos y reglas de direcciones IP.
        </p>
      </div>
    </div>
  );
