...
export default function CloudflarePageClient() {
  return (
    <div className="space-y-6 animate-fadeIn pb-20 max-w-7xl mx-auto">
      <ModuleHeader title="Cloudflare" subtitle="Integración con Cloudflare para protección y CDN" icon="Cloud" />
      <div className="flex flex-col items-center justify-center min-h-[400px] bg-[var(--bg-card)] rounded-2xl border border-[var(--border-subtle)] p-12">
        <div className="w-16 h-16 bg-violet-100 dark:bg-violet-900/30 rounded-2xl flex items-center justify-center mb-4">
          <Icon name="Cloud" className="w-8 h-8 text-violet-500" />
        </div>
        <h3 className="text-lg font-black text-[var(--text-primary)] mb-2">Cloudflare</h3>
        <p className="text-sm text-[var(--text-secondary)] text-center max-w-md">
          Módulo en preparación. Aquí se configurará la integración con Cloudflare.
        </p>
      </div>
    </div>
  );
