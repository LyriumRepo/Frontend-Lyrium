    ...
    if (mode === 'comprobante') {
        return (
            <div className="px-4 pb-2">
                ...
                {loadingOrders && (
                    <div className="flex items-center gap-2 text-xs text-gray-400 dark:text-[var(--text-secondary)] py-2">
                ...
                {fetchError && (
                    <p className="text-xs text-gray-400 dark:text-[var(--text-secondary)] py-2">
                    ...
                    <div className="flex flex-col gap-1.5 max-h-48 overflow-y-auto">
                        {orders.map((order) => (
                            <button
                                ...
                                className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 dark:border-[var(--border-subtle)] bg-white dark:bg-[var(--bg-card)] text-xs text-left text-gray-700 dark:text-[var(--text-primary)] hover:bg-gray-50 dark:hover:bg-[var(--bg-muted)] hover:border-sky-300 dark:hover:border-sky-600 transition-all duration-200"
                            >
                                <Icon name="ShoppingBag" className="text-sm flex-shrink-0 text-sky-500" />
        ...
        <div className="px-4 pb-2">
            <div className="flex flex-wrap gap-2">
                <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 dark:border-[var(--border-subtle)] bg-white dark:bg-[var(--bg-card)] text-xs text-gray-700 dark:text-[var(--text-primary)] hover:bg-gray-50 dark:hover:bg-[var(--bg-muted)] hover:border-sky-300 dark:hover:border-sky-600 transition-all duration-200"
                >
