...
export default function Pagination({ page, totalPages, onPageChange, totalItems, itemLabel }: PaginationProps) {
    ...
    return (
        <div className="flex items-center justify-between px-4 pt-1">
            <p className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-widest">
                ...
                {totalItems !== undefined && ` · ${totalItems} ${itemLabel ?? 'registros'}`}
            </p>
