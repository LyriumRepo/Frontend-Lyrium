                ...
                {kpis.map((kpi) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="p-2.5 bg-cyan-500/10 text-cyan-500 dark:text-cyan-400 rounded-xl">
            ...
            <div className="bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-[var(--border-subtle)] shadow-sm relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-end relative z-10">
                    ...
                    <button
                        ...
                        className="lg:col-span-2 w-full p-4 bg-cyan-600 text-white rounded-2xl hover:bg-cyan-700 transition-all shadow-xl shadow-cyan-600/20 flex items-center justify-center gap-2 whitespace-nowrap active:scale-95 duration-300"
                    >
                    ...
                    <table className="w-full text-left border-collapse" aria-label="Tabla de contratos">
                        ...
                        <tbody className="divide-y divide-[var(--border-subtle)]">
                            {contracts.map((c: Contract) => (
                                ...
                                >
                                    {/* ID */}
                                    <td className="px-8 py-6 font-mono font-black text-xs text-[var(--text-muted)] group-hover:text-cyan-600 transition-colors">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-3">
                                            <div className="w-9 h-9 rounded-xl bg-cyan-500/10 text-cyan-500 flex items-center justify-center shrink-0 font-black text-xs">
                                    ...
                                    <td className="px-8 py-6 text-right whitespace-nowrap">
                                        <div className="w-8 h-8 rounded-xl flex items-center justify-center text-[var(--text-muted)] group-hover:text-cyan-600 group-hover:bg-cyan-500/10 transition-all shrink-0 ml-auto">
