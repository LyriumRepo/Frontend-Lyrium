          ...
          <div className="overflow-hidden w-full py-2">
            ...
            >
              {allItems.map((product, index) => (
                ...
                >
                  <div
                    className="group bg-white dark:bg-[#1E3028] rounded-[14px] p-5 text-center shadow-[0_8px_25px_rgba(0,0,0,0.15)] border border-transparent transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_15px_35px_rgba(0,0,0,0.3)] flex flex-col justify-between h-full min-h-[360px] cursor-default"
                  >
                    ...
                    <div className="mt-auto">
                      ...
                      <p className="text-[16px] font-black text-rose-600 dark:text-white">
