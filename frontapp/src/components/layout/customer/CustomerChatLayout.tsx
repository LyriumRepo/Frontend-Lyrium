 ...
 * por debajo de lg (1024px), estilo WhatsApp, controlado por `mobileView`.
 *
 * De lg hacia arriba el resultado visual es PIXEL-IDÉNTICO al ChatLayout
...
interface CustomerChatLayoutProps {
  ...
  /**
   * Qué panel se muestra en mobile/tablet (< 1024px).
   * De lg en adelante siempre se ven ambos paneles, igual que antes.
   */
...
export default function CustomerChatLayout({
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-12 lg:gap-4 h-full min-h-0">
      ...
      <div
        ...
        `}
      >
        <div className="hidden lg:block h-1 w-full shrink-0 bg-gradient-to-r from-[#9cb04e] via-[#64c695] to-[#499bbf] rounded-t-[2.5rem]" />
        {list}
      </div>
